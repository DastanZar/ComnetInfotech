        ...
        <StaggerWrapper className="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-6">
          {segments.map((segment, index) => (
            <StaggerItem key={index}>
              ...
              >
                <Card variant="bordered" className="h-full text-center group hover:border-accent">
                  <div className="w-16 h-16 mx-auto mb-4 rounded-2xl bg-accent-muted flex items-center justify-center text-accent group-hover:bg-accent group-hover:text-white transition-colors">
                    {segment.icon}
                  </div>
                  <h3 className="text-lg font-semibold text-primary mb-2">{segment.title}</h3>
